...
<body>
        ...
        <thead>
            <tr>
                ...
                <th class="text-center">
                    ...
                    <h5>PERSONAL DE LA DIRECCIÓN DISTRITAL DE EDUCACIÓN CHAYANTA</h5>
                </th>
    ...
    <div class="">
        ...
        <table class="table table-bordered table-sm" style="font-size: small">
            ...
            @endphp
            <caption>Dia y fecha: {{ $dia}}, {{ $mifecha}}</caption>
                            ...
                            @foreach ($asistencias_del_personal as $asis)
                                @if ($contador_asistencias_del_personal >= 4)
                                    ...
                                    @else
                                        ...
                                        @if ($asis >= '12:00:00' && $asis < '18:00:00')
                                            @if ($s_m == "")
                                                @php
                                                    $s_m = $asis;
                                                @endphp
                                ...
                                @else
                                    ...
                                    @if ($asistencias_del_personal[0] < '12:00:00')
                                        @if ($asis < '12:00:00')
                                            @if ($e_m == "")
                                                @php
                                                    $e_m = $asis;
